...
# Configure CORS to allow requests from MediTrack frontend
...
def add_security_headers(response):
    # Add Content Security Policy header that allows everything needed for the chatbot
    response.headers['Content-Security-Policy'] = "default-src * 'unsafe-inline' 'unsafe-eval' data: blob:; script-src * 'unsafe-inline' 'unsafe-eval' blob:; connect-src * 'unsafe-inline'; img-src * data: blob:; frame-src *; style-src * 'unsafe-inline';"
    return response
